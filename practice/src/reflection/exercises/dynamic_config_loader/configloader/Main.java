package reflection.exercises.dynamic_config_loader.configloader;

import reflection.exercises.dynamic_config_loader.data.GameConfig;
import reflection.exercises.dynamic_config_loader.data.UserInterfaceConfig;
