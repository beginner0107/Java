package reflection.exercises.config_parser_part2.configloader;

import reflection.exercises.config_parser_part2.data.GameConfig;
import reflection.exercises.config_parser_part2.data.UserInterfaceConfig;
...
public class ConfigLoaderLibrary {
    private static final Path GAME_CONFIG_PATH = Path.of("resources/game-properties-02.cfg");
    private static final Path UI_CONFIG_PATH = Path.of("resources/user-interface-02.cfg");
