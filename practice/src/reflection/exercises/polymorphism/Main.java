package reflection.exercises.polymorphism;

import reflection.exercises.polymorphism.database.DatabaseClient;
import reflection.exercises.polymorphism.http.HttpClient;
import reflection.exercises.polymorphism.logging.FileLogger;
import reflection.exercises.polymorphism.udp.UdpClient;
...
public class Main {
    public static void main(String[] args) throws Throwable {
        ...
        Map<Object, Method> requestExecutors =
                groupExecutor(Arrays.asList(databaseClient, httpClient1, httpClient2, fileLogger, udpClient),
